package structures.trees.auxiliary.classes;

import structures.auxiliary.classes.concrete.ComparableNode;
import structures.auxiliary.interfaces.ComparableValue;
import structures.vectors.ArrayList;
import static structures.trees.auxiliary.interfaces.Tree.IN_ORDER;
import static structures.trees.auxiliary.interfaces.Tree.POST_ORDER;
import static structures.trees.auxiliary.interfaces.Tree.PRE_ORDER;
 ...
 */
public final class BinarySearchTreeNode<T extends Comparable> extends ComparableNode<T> {
