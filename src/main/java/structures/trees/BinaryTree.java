...
public interface BinaryTree<K, V> extends DataStructure<K>, Iterable<Pair<K, V>> {
     ...
     */
    default boolean insert(Pair<K, V> pair) {
    ...
    default Iterator<Pair<K, V>> iterator() {
        return new BinaryTree.BinaryTreeIterator<K, V>(this, DEFAULT_ORDER);
    }
...
//==============================================================================
    ...
    class BinaryTreeIterator<K, V> implements Iterator<Pair<K, V>> {
         ...
         */
        @SuppressWarnings("unused")
        private BinaryTreeIterator(BinaryTree<K, V> tree, int traversalType) {
